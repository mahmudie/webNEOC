namespace webNEOC.ImportGate {
    export interface TempCampaignRow {
    ...
    export namespace TempCampaignRow {
        export const idProperty = 'TempCampaignId';
        export const nameProperty = 'PemtremtManager';
        export const localTextPrefix = 'ImportGate.TempCampaign';

        export namespace Fields {
            export declare const TempCampaignId: string;
            ...
            export declare const HhNo: string;
