...
namespace webNEOC.PostCampaign.Endpoints
{
    ...
    using MyRepository = Repositories.LQASRepository;
    using MyRow = Entities.LQASRow;

    [RoutePrefix("Services/PostCampaign/LQAS"), Route("{action}")]
    [ConnectionKey(typeof(MyRow)), ServiceAuthorize(typeof(MyRow))]
    public class LQASController : ServiceEndpoint
    {
        ...
        public int ApproveLqas(IDbConnection connection)
        {
            int? UserId = 0;
            int? TenantId = 0;
            ...
            connection.Execute("ApproveLqas",
                        param: new
                        {
                            UserId = UserId,
                            Approved = true,
