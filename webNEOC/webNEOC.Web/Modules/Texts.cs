    ...
    public static partial class Texts
    {
        public static class Db
        {
            public static class Administration
            {
                public static class Translation
                {
                    ...
                    public static LocalText AppTitle = "Afghanistan National Vaccination Central Database";
                }
            }
        }
        ...
        public static class Forms
        {
            public static class Membership
            {
                ...
                {
                    public static LocalText EmailSubject = "Reset Your webNEOC Password";
                ...
                {
                    public static LocalText FormTitle = "National <b>EOC</b>";
                    ...
                    public static LocalText WelcomeMessage = "Welcome to NEOC online database";
                }

                public static class SignUp
                {
                    public static LocalText ActivateEmailSubject = "Activate Your NEOC Data Platform Account";
                    ...
                    public static LocalText FormTitle = "Sign up for NEOC";
        ...
        public static class Navigation
        {
            ...
            public static LocalText SiteTitle = "NEOC";
        }
        ...
        public static class Site
        {
            ...
            {
                public static LocalText ContentDescription = "sample data";
            ...
            public static class Layout
            {
                ...
                public static LocalText FooterInfo = "NEOC Database";
                public static LocalText FooterRights = "All rights reserved. Developed by KITS (www.kamyab.tech)";
                ...
                public static LocalText ThemeAzure = "NEOC";
                public static LocalText ThemeAzureLight = "NEOC Light";
