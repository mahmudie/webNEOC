...
//[assembly: NavigationLink(9000, "Administration/Exceptions Log", url: "~/errorlog.axd", permission: webNEOC.Administration.PermissionKeys.Security, icon: "icon-ban", Target = "_blank")]
