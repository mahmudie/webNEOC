...
namespace webNEOC.Implementation.Endpoints
{
    ...
    using MyRepository = Repositories.IcnRepository;
    using MyRow = Entities.IcnRow;

    [RoutePrefix("Services/Implementation/Icn"), Route("{action}")]
    [ConnectionKey(typeof(MyRow)), ServiceAuthorize(typeof(MyRow))]
    public class IcnController : ServiceEndpoint
    {
        ...
        public int ApproveICN(IDbConnection connection)
        {
            int? UserId = 0;
            int? TenantId = 0;
