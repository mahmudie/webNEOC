...
namespace webNEOC.Controllers
{
    ...
    [RoutePrefix("District"), Route("{action=index}")]
    [PageAuthorize()]
    public class DistrictController : Controller
    {
        ...
        public static void ExcelQueryEvent(object sender, object args)
        {
            ...
            if (data.Column != 1 && data.Column != 2 && data.Column != 3 && data.Column != 4 && data.Column != 5 && data.Column != 6 && data.Column != 7 && data.Column != 9)
            {
        ...
        public void ExportToExcel(string TreeGridModel)
        {
            ...
            exp.Export(obj, DataSource, "District_coverage.xlsx", ExcelVersion.Excel2013, new TreeGridExportSettings() { Theme = ExportTheme.FlatAzure});
        }
